...
instance Eq Identifier where
	...
	ArrayPidentifier name indexName _ _ == ArrayPidentifier name' indexName' _ _ = name == name' && indexName == indexName'
	ArrayNum name index _ == ArrayNum name' index' _ = name == name' && index == index'
	_ == _ = False
